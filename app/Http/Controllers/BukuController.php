...
class BukuController extends Controller
{
    ...
    public function create()
    {
        ...
        $penerbits = Penerbit::WhereNotExists(function($query) {
            $query->select(DB::raw(1))
            ->from('buku')
            ->whereRaw('buku.penerbit_id = penerbits.penerbit');
         })->get();
    ...
    {
        $data = [['judul' => null, 'isbn' => null, 'pengarang' => null, 'penerbit_id' => null, 'tahun_terbit' => null, 'jumlah_buku' => null, 'deskripsi' => null, 'lokasi' => 'rak1/rak2/rak3']];
    ...
    public function show($id)
    {
        ...
        return view('buku.show', compact('data','penerbits'));
    }
    ...
    {   
        ...
        return view('buku.edit', compact('penerbits','data'));
    }
