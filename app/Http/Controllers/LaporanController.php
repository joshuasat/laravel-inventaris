    ...
    public function bukuExcel(Request $request)
    {
       ...
       // $sheet->appendRow(array_keys($datas[0]));
        $sheet->row($sheet->getHighestRow(), function ($row) {
         ...
         $datasheet = array();
         $datasheet[0]  =   array("NO", "NAMA", "KONDISI", "KETERANGAN","TANGGAL REGISTRASI","JUMLAH");
         $i=1;
...
public function transaksiExcel(Request $request)
    {
       ...
       // $sheet->appendRow(array_keys($datas[0]));
        $sheet->row($sheet->getHighestRow(), function ($row) {
         ...
         $datasheet = array();
         $datasheet[0]  =   array("NO", "KODE TRANSAKSI", "INVENTARIS", "PEMINJAM",  "TGL PINJAM","TGL KEMBALI","STATUS", "KET");
         $i=1;
