          ...
          <li class="nav-item {{ setActive(['anggota*', 'buku*', 'user*']) }}">
            ...
            <div class="collapse {{ setShow(['anggota*', 'buku*', 'user*']) }}" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link {{ setActive(['anggota*']) }}" href="{{route('anggota.index')}}">Data Pegawai</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ setActive(['buku*']) }}" href="{{route('buku.index')}}">Data Inventaris</a>
                </li>
                 <li class="nav-item">
                  <a class="nav-link {{ setActive(['user*']) }}" href="{{route('user.index')}}">Data User</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ setActive(['penerbit*']) }}" href="{{route('penerbits.index')}}">Data Ruangan</a>
                </li>
              </ul>
            </div>
          </li>
