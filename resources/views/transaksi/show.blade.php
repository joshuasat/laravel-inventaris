                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="anggota_id" class="col-md-4 control-label">Inventaris</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="anggota_id" class="col-md-4 control-label">Pegawai</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('jmlh_pinjam') ? ' has-error' : '' }}">
                            <label for="jmlh_pinjam" class="col-md-4 control-label">Jumlah Pinjam</label>
                            <div class="col-md-6">
                                <input id="jmlh_pinjam" type="number" class="form-control" name="jmlh_pinjam" value="{{ $data->jmlh_pinjam }}" readonly="">
                            </div>
                        </div>
