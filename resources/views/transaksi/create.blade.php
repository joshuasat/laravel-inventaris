                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Transaksi baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('buku_id') ? ' has-error' : '' }}">
                            <label for="buku_id" class="col-md-4 control-label">Inventaris</label>
                            <div class="col-md-6">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-info btn-secondary" data-toggle="modal" data-target="#myModal"><b>Cari Inventaris</b> <span class="fa fa-search"></span></button>
                                </span>
                                </div>
  ...
  <div class="modal-dialog modal-lg" role="document" >
    <div class="modal-content" style="background: #fff;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Cari Inventaris</h5>
